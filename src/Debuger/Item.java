...
public class Item {
    ...
    private Image getImage() {
        switch(type) {
            case CHEESE:
                return Resource.Cheese[((Cheese) owner).getSize() - 1];
            case POISON:
                return Resource.Poison[((Cheese) owner).getSize() - 1];
            case Wall:
                return Resource.WallImg;
            case Ladder:
                return Resource.LadderImg;
            case BROWN_RAT:
                return Resource.BrownRatImg;
            case GRAY_RAT:
                return Resource.GrayRatImg;
            default:
                return Resource.WallImg;
        }
    }
    ...
    public void paint(Graphics g, Color color) {
        ...
        g2d.fillRect(17+fixX, 48+fixY, cellSize, cellSize);
    }
